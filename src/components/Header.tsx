...
export default function App() {
    ...
    return (
        <nav className="navbar navbar-expand-lg bg-black" style={{ padding: '0px 24px', height :"64px" }}>
            ...
            <div className={`offcanvas offcanvas-start ${showOffcanvas ? 'show' : ''}`} tabIndex={-1} id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel" style={{ boxShadow: showOffcanvas ? '0px 0px 10px rgba(0,0, 0, 5)' : 'none' }}>
                ...
                <div className="offcanvas-body">
                    <ul className="navbar-nav justify-content-start flex-grow-1 pe-3">
                        <MenuItem key='About' component={Link} to='/'>About</MenuItem>
                        <MenuItem key='My Project' component={Link} to='/my-project'>My Project</MenuItem>
                        <MenuItem key='Contact' component={Link} to='/contact'>Contact </MenuItem>
                    </ul>
                </div>
            </div>
